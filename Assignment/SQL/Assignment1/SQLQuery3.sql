...
CREATE TABLE Employees (Empno int  PRIMARY KEY, Ename varchar(20) NOT NULL,Job varchar(15),Salary INT CHECK (Salary > 0),Deptno INT,
...
Actual_End_date DATE,Budget INT CHECK (Budget > 0),Client_ID INT,
CONSTRAINT FK_Client FOREIGN KEY (Client_ID)
REFERENCES Clients(Client_ID),
CONSTRAINT CHK_Actual_End CHECK (Actual_End_date > Planned_End_Date));
...
CREATE TABLE EmpProjectTasks (Project_ID INT,Empno INT,Start_Date DATE,End_Date DATE,
...
CONSTRAINT FK_EPT_Employee FOREIGN KEY (Empno)
